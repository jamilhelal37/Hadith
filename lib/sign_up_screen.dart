...
import 'package:hadith/login_screen.dart';
import 'package:hadith/main_screen.dart';
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: TextFormField(controller: nameCont,
                          validator: (val){
                            if(nameCont.text.length<2){return "invalid name";}return null;
                          },
                      ...
                      SizedBox(
                        width: 250,
                        child: TextFormField(controller: emailCont,
                          validator: (val){
                      ...
                      SizedBox(
                        width: 250,
                        child: TextFormField(controller: passWordCont,
                          validator: (val){
